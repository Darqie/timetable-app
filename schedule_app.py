...
# Оновлений розподіл для більш компактного розміщення лейблу та поля вибору дати
col_date_picker, col_save_btn, col_download_btn, _ = st.columns([0.28, 0.1, 0.14, 0.48]) # Змінено пропорції
...
with col_date_picker:
    ...
    start_date = st.date_input("Перший день тижня:", date(2025, 6, 2), key="start_date_picker")
